                        ...
                        <div class="col-md-4 mb-4" data-animate="zoomIn">
                            <div class="card border-0">
                                ...
                                <div class="card-body px-0">
                                    <div class="mb-2"><a href="#" class="link-hover-dark-primary">{{$b["Blog_category"]}}</a> <a
                                            href="#" class="link-hover-dark-primary"></a></div>
                                    ...
                                    <ul class="list-inline">
                                        <li class="list-inline-item mr-0">
                                            <span class="text-gray">{{$b["created_at"]}} by</span>
                                        </li>
