                        ...
                        <div class="store-listing-style store-listing-style-02">
                            <div class="mb-6">
                                ...
                                <h3> 
                                      ...
                                      Contact here: {{$vendor->Medical_mobile_number}}
                                      <br>
                                      City:   {{$vendor->Medical_city}}
                                        
                                        @if($vendor->Medical_status == "1")
                                        <p style="color:red">New</p>   
                                        @else
                                        <p style="color:green">Verified</p>
                                        @endif 
                                 
                                    <a href="https://www.{{$vendor->Medical_website_URl}}" class="btn btn-danger">
