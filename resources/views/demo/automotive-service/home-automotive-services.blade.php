...
<head>
    ...
    <title>Home automotive services | TheDir</title>
...
<body>
    ...
    <div id="site-wrapper" class="site-wrapper home-automotive-service">
                    ...
                    <nav class="navbar navbar-expand-xl">
                        <div class="header-mobile d-flex d-xl-none flex-fill justify-content-between align-items-center">
                            ...
                            <a class="navbar-brand navbar-brand-mobile" href="home-automotive-services.html">
                                <img src="{{asset('images/white-logo.png')}}" alt="The dir">
                            </a>
                        ...
                        <div class="collapse navbar-collapse d-xl-flex align-items-center" id="navbar-main-menu">
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    ...
                                    <ul class="sub-menu x-animated x-fadeInUp">
                                        ...
                                        <li class="nav-item"><a class="nav-link"
                                                                href="{{route('demo/automotive-service/home-automotive-services')}}">
                                            automotive service</a></li>
                                        <li class="nav-item"><a class="nav-link"
                                                                href="{{route('demo/food-and-restaurant/home-food-and-restaurant')}}">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="sub-menu x-menu-mega x-animated x-fadeInUp width-500">
                                        <div class="container">
                                            <div class="row w-100">
                                                <div class="col-lg-6">
                            ...
                            <div class="header-customize justify-content-end align-items-center d-none d-xl-flex ml-auto">
                                ...
                                <div class="header-customize-item toggle">
                                    <a href="#canvas-menu" data-gtf-mfp="true"
                                       data-mfp-options='{"type":"inline","showCloseBtn":false}'>
                                        <svg class="icon icon-ionicons_svg_md-menu">
                                            <use xlink:href="#icon-ionicons_svg_md-menu"></use>
                                        </svg>
                                    </a>
                                </div>
                            </div>
        ...
        <div class="content-wrap">
                    ...
                    <div class="banner-content">
                        <div class="heading" data-animate="fadeInLeft">
                            <h1 class="mb-0 text-white">
                                <span class="d-block lh-1">Find automotive services</span>
                                <span class="d-block lh-1">near you so easy</span>
                            </h1>
                        </div>
                            ...
                            <form>
                                <div class="row align-items-end">
                                    <div class="col-xl-6 mb-4 mb-xl-0">
                                        ...
                                        <div class="input-group dropdown rounded">
                                            <input type="text" id="key-word" name="key-word"
                                                   class="form-control font-size-lg border-0 form-control-lg bg-transparent"
                                                   placeholder="eg: personal trainers, house cleaning"
                                    ...
                                    <div class=" col-xl-4 mb-4 mb-xl-0">
                                        <label for="region" class="text-white font-weight-bold text-uppercase">where do
                                            you need it?</label>
                                        <div class="input-group dropdown rounded">
                                            <input type="text" id="region" name="region"
                                                   class="form-control font-size-lg border-0 form-control-lg bg-transparent"
                                                   placeholder="Town, city or postcode" data-toggle="dropdown"
                                                   aria-haspopup="true" autocomplete="off">
                                            <a href="#" class="input-group-append text-decoration-none" data-toggle="dropdown">
                                                <i class="fal fa-chevron-down"></i>
                                            </a>
                                    ...
                                    <div class=" col-xl-2">
                                        <button type="submit"
                                                class="btn btn-primary font-weight-bold font-size-h5 btn-block btn-icon-left btn-lg lh-16">
                                            <i
                                ...
                                <div class="advance-search mt-7">
                                    <a class="text-white font-weight-bold text-uppercase text-decoration-none"
                                       data-toggle="collapse" href="#advanceSearch" role="button"
                                       aria-expanded="false">advance search<i class="fal fa-chevron-down"></i></a>
                                </div>
                                <div id="advanceSearch" class="collapse form-advance-search mt-4">
                                    <div class="row">
                                        <div class=" col-md-6 mb-4 mb-md-0">
                                            <div class="form-group">
                                                <div class="form-label text-white font-weight-bold text-uppercase mb-2">
                                                    Filter by tags
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="custom-control custom-checkbox lh-19">
                                                            <input class="custom-control-input" type="checkbox"
                                                                   id="pets">
                                                            <label class="custom-control-label text-white" for="pets">
                                                                Pets Friendly
                                                            </label>
                                        ...
                                        <div class=" col-md-4 mb-4 mb-md-0">
                                            <div class="price-range">
                                                <label
                                                       class="form-label text-white font-weight-bold text-uppercase">
                                                    Price Range
                                                </label>
                                                <div class="price-range-wrapper d-flex flex-column justify-content-center">
                                                    <div id="price" data-slider="true"
                                                         data-slider-options='{"min":0,"max":4000,"values":[0,2000]}'></div>
                                                    <div class="description mt-3 text-white">
            ...
            <!-- #section 01 start -->
            <section id="section-01" class="border-bottom py-8">
                <div class="container">
                    <div class="position-relative client-logo inline">
                        <h4 class="font-weight-light mb-0 d-inline position-absolute">
                            Trusted by
                        </h4>
                        <div class="slick-slider"
                             data-slick-options='{"slidesToShow": 5,"autoplay":true,"dots":false,"arrows":false,"responsive":[{"breakpoint": 992,"settings": {"slidesToShow": 4}},{"breakpoint": 770,"settings": {"slidesToShow": 3}},{"breakpoint": 576,"settings": {"slidesToShow": 2}},{"breakpoint": 400,"settings": {"slidesToShow": 1}}]}'>
                            <div class="box">
                                <a href="#" class="item">
                                    <img src="../../images/listing/trust-by-1.png" alt="Client logo">
                                </a>

                            </div>
                            <div class="box">
                                <a href="#" class="item">
                                    <img src="../../images/listing/trust-by-2.png" alt="Client logo">
                                </a>
                            </div>
                            <div class="box">
                                <a href="#" class="item">
                                    <img src="../../images/listing/trust-by-3.png" alt="Client logo">
                                </a>
                            </div>
                            <div class="box">
                                <a href="#" class="item">
                                    <img src="../../images/listing/trust-by-4.png" alt="Client logo">
                                </a>
                            </div>
                            <div class="box">
                                <a href="#" class="item">
                                    <img src="../../images/listing/trust-by-5.png" alt="Client logo">
                                </a>
                            </div>
                            <div class="box">
                                <a href="#" class="item">
                                ...
                                <div class="position-relative store-image">
                                    ...
                                    <div class="image-content position-absolute d-flex align-items-center">
                                        <div class="content-right ml-auto d-flex">
                                            <a href="../../images/shop/full-automotic-service-provider-1.jpg"
                                               class="item viewing"
                                               data-toggle="tooltip"
                                               data-placement="top"
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-inline store-meta mb-4 font-size-sm d-flex align-items-center flex-wrap">
                                        ...
                                        <li class="list-inline-item"><span class="mr-1">From</span><span
                                                class="text-danger font-weight-semibold">$25.00</span></li>
                                        <li class="list-inline-item separate"></li>
                                    ...
                                    <div class="card-footer rounded-0 border-top pt-3 bg-transparent px-0 pb-0 mt-3">
                                        ...
                                        <a href="#" class="text-secondary text-decoration-none address">534 Diamond
                                            St, Barcelona,
                                            Spain</a>
                                    </div>
                                </div>
                        ...
                        <div class="box" data-animate="slideInDown">
                            <div class="store card border-0 rounded-0 h-auto">
                                <div class="position-relative store-image">
                                    ...
                                    <div class="image-content position-absolute d-flex align-items-center">
                                        <div class="content-right ml-auto d-flex">
                                            <a href="../../images/shop/full-automotic-service-provider-2.jpg"
                                               class="item viewing"
                                               data-toggle="tooltip"
                                               data-placement="top"
                                               title="Quickview" data-gtf-mfp="true">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-inline store-meta mb-4 font-size-sm d-flex align-items-center flex-wrap">
                                        ...
                                        <li class="list-inline-item separate"></li>
                                        <li class="list-inline-item"><span class="mr-1">From</span><span
                                                class="text-danger font-weight-semibold">$18.00</span></li>
                                        <li class="list-inline-item separate"></li>
                                        <li class="list-inline-item"><span class="text-green">Open now!</span></li>
                                    </ul>
                                    <div class="card-footer rounded-0 border-top pt-3 bg-transparent px-0 pb-0 mt-3">
                                        ...
                                        <a href="#" class="text-secondary text-decoration-none address">Ubud,
                                            Indonesia</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="box" data-animate="slideInDown">
                            <div class="store card border-0 rounded-0 h-auto">
                                <div class="position-relative store-image">
                                    ...
                                    <div class="image-content position-absolute d-flex align-items-center">
                                        <div class="content-right ml-auto d-flex">
                                            <a href="../../images/shop/full-automotic-service-provider-3.jpg"
                                               class="item viewing"
                                               data-toggle="tooltip"
                                               data-placement="top"
                                               title="Quickview" data-gtf-mfp="true">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-inline store-meta mb-4 font-size-sm d-flex align-items-center flex-wrap">
                                        ...
                                        <li class="list-inline-item separate"></li>
                                        <li class="list-inline-item"><span class="mr-1">From</span><span
                                                class="text-danger font-weight-semibold">$50.00</span></li>
                                        <li class="list-inline-item separate"></li>
                                        <li class="list-inline-item"><span class="text-green">Open now!</span></li>
                                    </ul>
                                    <div class="card-footer rounded-0 border-top pt-3 bg-transparent px-0 pb-0 mt-3">
                                        ...
                                        <a href="#" class="text-secondary text-decoration-none address">Via Paolo
                                            Sacchi 8, 10128
                                            Turin, Italy</a>
                                    </div>
                                </div>
                        ...
                        <div class="box" data-animate="slideInDown">
                            <div class="store card border-0 rounded-0 h-auto">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-footer rounded-0 border-top pt-3 bg-transparent px-0 mt-3">
										<span
                ...
                <div class="container">
                    <div class="heading text-center mb-9">
                        ...
                        <div class="font-size-lg mb-0">
                            With over 5000 inviduals and centers in the automotive field directory provides a listing of
                            all provides
                            across a wide variety if automotive fields
                        </div>
                    </div>
            ...
            <section class="section-01 py-12" id="section-06">
                <div class="container">
                            ...
                            <div class="slick-slider arrow-center equal-height testimonials-slider"
                                ...
                                <div class="box">
                                    <div class="card testimonial-item h-100 border-0">
                                        <div class="card-title text-uppercase font-weight-medium text-gray mb-3">Selena
                                            hired
                                            Car painting
                                        </div>
                                        <div class="card-body h5 font-weight-normal px-0 mb-0 lh-15 letter-spacing-35">
                                            ...
                                            I am very pleased with the photographer that I hired, his work is top notch
                                            and he has a commendable
                                            attitude - very hard working, pleasant, punctual and respectful. Would
                                            highly recommend Thedir to anyone, excellent.
                                        </div>
                                        <div class="card-footer bg-transparent px-0 pt-6 pb-0">
                                            <div class="media">
                                                <a href="#" class="author-image mr-3"><img
                                                        src="../../images/listing/automotic-service-testimonial-1.png"
                                                        alt="Testimonial 1">
                                                </a>
                                                <div class="media-body lh-14">
                                                    <a href="#" class="font-size-lg text-link lh-11">Brooklyn Car
                                                        Services Center</a>
													...
													<span class="rate-item checked">
                                                        ...
                                                        <span class="font-size-md text-gray ml-3 d-inline-block">(08 Reviews)</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="box">
                                    <div class="card testimonial-item h-100 border-0">
                                        <div class="card-title text-uppercase font-weight-medium text-gray mb-3">Victor
                                            hired
                                            Car Assemble Carbon
                                        </div>
                                        <div class="card-body h5 font-weight-normal px-0 mb-0 lh-15 letter-spacing-35">
                                            ...
                                            First time I've used. Was looking for photographer for
                                            party.
                                            Got lots of people bidding and found perfect guy for the job. Would
                                            definitely recommend.
                                        </div>
                                        <div class="card-footer bg-transparent px-0 pt-6 pb-0">
                                            <div class="media">
                                                <a href="#" class="author-image mr-3"><img alt="Author image"
                                                                                           src="../../images/listing/automotic-service-testimonial-2.png">
                                                </a>
                                                <div class="media-body lh-14">
                                                    <a href="#" class="font-size-lg text-link lh-11">Michealin
                                                        Automotive
                                                        Shop</a>
                                                    <div class="author-rate align-items-end mt-1">
													<span class="rate-item checked">
                                                        ...
                                                        <span class="font-size-md text-gray ml-3 d-inline-block">(24 Reviews)</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="box">
                                    <div class="card testimonial-item h-100 border-0">
                                        <div class="card-title text-uppercase font-weight-medium text-gray mb-3">
                                            ceridwen
                                            hired cleaning car interior
                                        </div>
                                        <div class="card-body h5 font-weight-normal px-0 mb-0 lh-15 letter-spacing-35">
                                            <svg class="icon icon-quotes-left">
                                                <use xlink:href="#icon-quotes-left"></use>
                                            </svg>
                                            Great way of finding a number of people to assist in such a
                                            quick turn around. Great service .
                                            i was pleasantly surprised by the quality and professionalism of the
                                            service providers especially as my first time using thedir .
                                        </div>
                                        <div class="card-footer bg-transparent px-0 pt-6 pb-0">
                                            <div class="media">
                                                <a href="#" class="author-image mr-3"><img
                                                        src="../../images/listing/automotic-service-testimonial-3.png"
                                                        alt="Testimonial 2">
                                                </a>
                                                <div class="media-body lh-14">
                                                    <a href="#" class="font-size-lg text-link lh-11">CG Automotive
                                                        Services Center</a>
                                                    <div class="author-rate align-items-end mt-1">
													<span class="rate-item checked">
														<svg class="icon icon-ionicons_svg_md-star"><use
                                                        ...
                                                        <span class="font-size-md text-gray ml-3 d-inline-block">(15 Reviews)</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="pt-11 text-dark text-center font-size-md">
                        Read more of what people are saying about Thedir on <a href="#">Trustpilot.com</a>
                    </div>
                </div>
            </section>
            <!-- /#section-06 end -->
                    ...
                    <div class="row align-items-center">
                        <div class="text-white col-lg-9">
                            <h2 class="mb-1 text-white">
                                Are you an automotive services provider?
                            </h2>
                            <p class="mb-0 font-size-md">
                                Learn how Thedir can help you double your business
                            </p>
                        </div>
        ...
        <!-- #footer start -->
        <footer class="main-footer main-footer-style-01 bg-gray-04 pt-12">
            <div class="footer-second">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 col-lg-4 mb-6 mb-lg-0">
                            <div class="mb-8"><img src="../../images/black-logo.png" alt="Thedir"></div>
                            <div class="mb-7">
    ...
    <div id="canvas-menu" class="mfp-hide mfp-popup mfp-with-anim canvas-menu">
        ...
        <div class="menu mb-12" id="menu">
            <ul class="list-group list-group-flush list-group-borderless">
                <li class="list-group-item p-0">
                    <a href="#" data-toggle="collapse" data-target="#itemOne"
                       aria-expanded="true" aria-controls="itemOne"
                       class="text-decoration-none font-size-h2 font-weight-semibold">Demo</a>
                    <ul id="itemOne"
                ...
                <li class="list-group-item p-0">
                    <a class="menu-link collapsed text-decoration-none font-size-h2 font-weight-semibold" href="#"
                       data-toggle="collapse" data-target="#itemFour"
                       aria-expanded="true" aria-controls="itemFour">Pages </a>
                    <ul id="itemFour"
        ...
        <div class="text-dark">
            <p class="mb-0">&copy;Thedir 2017. All Rights Reseverd</p>
