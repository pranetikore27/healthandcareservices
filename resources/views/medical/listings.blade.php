...
<div class="page-container">
                    <div class="container-fluid">
                        <div class="page-content-wrapper d-flex flex-column">
                            ...
                            <h1 class="font-size-h4 mb-4 font-weight-normal">Add new Hospital</h1>
                            </a>
...
<thead>
    ...
    <td>
        ...
        ?>
             <a class="btn btn-info" href="{{ route('category.edit',$encrypted) }}">Edit</a>    

        
        <form action="{{ route('category.destroy',$encrypted) }}" method="Post">
                            @csrf
                            @method('DELETE')
